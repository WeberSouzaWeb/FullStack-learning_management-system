        ...
        if (action === 'add') {
            ...
            if (title) {
                const newChapter = {
                    ...
                    chapterContent: [],
                    collapsed: false,
                    chapterorder: chapters.length > 0 ? chapters.slice(11)[0].chapterOrder +
                        1 : 1,
                };
        ...
        <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
            <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full'>
                ...
                <div>
                    ...
                    <div className='flex justify-center items-center bg-blue-100 p-2 rounded-1g cursor-pointer' onClick={() => handleChapter('add')}>+ Add Chapter</div>
                    {showPopup && (
